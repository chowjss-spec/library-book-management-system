...
RUN curl -O https://repo1.maven.org/maven2/com/mysql/mysql-connector-j/8.0.31/mysql-connector-j-8.0.31.jar && mv mysql-connector-j-8.0.31.jar /usr/local/tomcat/lib/
